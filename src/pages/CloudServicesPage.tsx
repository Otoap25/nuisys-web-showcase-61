        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex items-center space-x-4 mb-8">
              ...
              <div>
                <h1 className="text-responsive-xl font-bold text-tech-blue">Cloud & AI Solutions</h1>
                <p className="text-tech-teal font-semibold text-xl">Future-Ready Technology</p>
              </div>
            </div>
