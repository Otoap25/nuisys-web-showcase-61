...
import { ArrowLeft, Camera, Shield, Eye, Clock, Smartphone, HardDrive } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Round-the-clock surveillance with real-time alerts and notifications"
    },
    {
      icon: Shield,
      title: "Advanced Security",
      description: "Motion detection, facial recognition, and intelligent analytics"
    },
    {
      icon: Smartphone,
      title: "Remote Access",
      description: "View live feeds and recordings from anywhere using mobile apps"
    },
    {
      icon: HardDrive,
      title: "Cloud Storage",
      description: "Secure cloud backup with local storage redundancy options"
    },
    {
      icon: Clock,
      title: "Recording History",
      description: "Extended recording capabilities with intelligent search features"
    },
    {
      icon: Camera,
      title: "HD Quality",
      description: "4K resolution cameras with night vision and weather resistance"
    }
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-responsive-xl font-bold text-tech-blue">CCTV Systems</h1>
                    <p className="text-tech-teal font-semibold text-lg">Advanced Surveillance Solutions</p>
                  </div>
                </div>
                
                <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  Professional CCTV installation and monitoring services with cutting-edge technology 
                  for complete security coverage of your premises.
                </p>
              ...
              <div className="relative">
                ...
                <img
                  src={securityImage}
                  alt="Professional CCTV Systems Installation"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our CCTV systems combine the latest technology with professional installation 
              and ongoing support for complete peace of mind.
            </p>
          </div>
