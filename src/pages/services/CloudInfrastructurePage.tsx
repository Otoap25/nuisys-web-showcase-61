...
import { ArrowLeft, Cloud, Server, Shield, TrendingUp, Settings, Zap } from "lucide-react";
...
const CloudInfrastructurePage = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Comprehensive monitoring and management dashboard"
    },
    {
      icon: Server,
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-responsive-xl font-bold text-tech-blue">Cloud Infrastructure</h1>
                    <p className="text-tech-teal font-semibold text-lg">Scalable Cloud Solutions</p>
                  </div>
                </div>
                
                <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  Professional cloud infrastructure services with migration support, multi-cloud deployment, 
                  and comprehensive security for scalable business operations.
                </p>
              ...
              <div className="relative">
                ...
                <img
                  src={cloudImage}
                  alt="Professional Cloud Infrastructure Services"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our cloud infrastructure solutions provide scalable, secure, and high-performance 
              platforms for modern business operations.
            </p>
          </div>
