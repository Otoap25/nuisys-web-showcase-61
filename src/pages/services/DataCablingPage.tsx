...
import { ArrowLeft, Wifi, Cable, Zap, Shield, Gauge, Settings } from "lucide-react";
import { Link } from "react-router-dom";
import Navbar from "@/components/Navbar";
import Footer from "@/components/Footer";
import infrastructureImage from "@/assets/infrastructure.jpg";

const DataCablingPage = () => {
  const features = [
    {
      icon: Cable,
      title: "Structured Cabling",
      description: "Cat6, Cat6a, and fiber optic cabling for high-speed data transmission"
    },
    {
      icon: Zap,
      title: "High Performance",
      description: "Support for gigabit speeds and future-ready infrastructure"
    },
    {
      icon: Shield,
      title: "Professional Standards",
      description: "Compliance with TIA/EIA standards and building codes"
    },
    {
      icon: Gauge,
      title: "Testing & Certification",
      description: "Comprehensive testing and certification of all cable installations"
    },
    {
      icon: Settings,
      title: "Custom Solutions",
      description: "Tailored cabling solutions for your specific business needs"
    },
    {
      icon: Wifi,
      title: "Network Infrastructure",
      description: "Complete network backbone installation and configuration"
    }
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-responsive-xl font-bold text-tech-blue">Data Cabling</h1>
                    <p className="text-tech-teal font-semibold text-lg">Structured Network Infrastructure</p>
                  </div>
                </div>
                
                <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  Professional structured cabling solutions with fiber optics, Cat6/Cat6a installations, 
                  and comprehensive testing for reliable high-speed network infrastructure.
                </p>
              ...
              <div className="relative">
                ...
                <img
                  ...
                  alt="Professional Data Cabling Services"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our structured cabling solutions provide the foundation for reliable, 
...
export default DataCablingPage;