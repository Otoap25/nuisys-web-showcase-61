...
import { ArrowLeft, Zap, Fuel, Settings, Shield, Gauge, Wrench } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Reliable backup power generation for extended outages"
    },
    {
      icon: Settings,
      title: "Automatic Start",
      description: "Seamless automatic startup and shutdown with transfer switches"
    },
    {
      icon: Fuel,
      title: "Multiple Fuel Options",
      description: "Diesel, natural gas, and propane generator solutions available"
    },
    {
      icon: Shield,
      title: "Weather Protection",
      description: "All-weather enclosures for reliable outdoor operation"
    },
    {
      icon: Gauge,
      title: "Load Management",
      description: "Intelligent load management systems for optimal performance"
    },
    {
      icon: Wrench,
      title: "Maintenance Service",
      description: "Comprehensive maintenance programs to ensure peak performance"
    }
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-responsive-xl font-bold text-tech-blue">Generators</h1>
                    <p className="text-tech-teal font-semibold text-lg">Emergency Power Solutions</p>
                  </div>
                </div>
                
                <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  Professional generator installation and maintenance services for reliable emergency power, 
                  with automatic transfer systems and comprehensive fuel options.
                </p>
              ...
              <div className="relative">
                ...
                <img
                  src={powerImage}
                  alt="Professional Generator Installation Services"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-6">
            <h2 className="text-responsive-lg font-bold text-tech-blue">
              Professional Generator Solutions
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our generator systems provide reliable emergency power with automatic operation 
