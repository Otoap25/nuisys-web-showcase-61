...
import { ArrowLeft, Server, Truck, Clock, Shield, CheckCircle, Users } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Strategic planning and execution to minimize business interruption"
    },
    {
      icon: Shield,
      title: "Secure Transfer",
      description: "Safe handling and transportation of sensitive IT equipment"
    },
    {
      icon: CheckCircle,
      title: "Project Management",
      description: "Dedicated project manager to oversee entire relocation process"
    },
    {
      icon: Users,
      title: "Expert Team",
      description: "Certified technicians experienced in complex office relocations"
    },
    {
      icon: Truck,
      title: "Full Service Moving",
      description: "Complete packing, transportation, and setup services"
    },
    {
      icon: Server,
      title: "IT Infrastructure",
      description: "Professional disconnection, transport, and reconnection of all IT systems"
    }
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-responsive-xl font-bold text-tech-blue">Office Relocation</h1>
                    <p className="text-tech-teal font-semibold text-lg">Seamless Business Transitions</p>
                  </div>
                </div>
                
                <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  Professional office relocation services with minimal downtime, secure equipment handling, 
                  and complete IT infrastructure management for smooth business transitions.
                </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our office relocation services ensure your business continues to operate smoothly 
