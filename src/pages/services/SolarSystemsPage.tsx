...
import { ArrowLeft, Sun, Leaf, TrendingDown, Battery, Settings, Shield } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "High-efficiency solar panels with optimal placement and configuration"
    },
    {
      icon: TrendingDown,
      title: "Cost Savings",
      description: "Significant reduction in electricity bills with long-term savings"
    },
    {
      icon: Leaf,
      title: "Environmental Impact",
      description: "Reduce carbon footprint with clean, renewable energy generation"
    },
    {
      icon: Battery,
      title: "Energy Storage",
      description: "Battery backup systems for energy independence and grid outages"
    },
    {
      icon: Settings,
      title: "Grid Integration",
      description: "Seamless integration with existing electrical infrastructure"
    },
    {
      icon: Shield,
      title: "Monitoring Systems",
      description: "Real-time performance monitoring and maintenance alerts"
    }
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-responsive-xl font-bold text-tech-blue">Solar Systems</h1>
                    <p className="text-tech-teal font-semibold text-lg">Sustainable Energy Solutions</p>
                  </div>
                </div>
                
                <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                  Professional solar system installation with energy storage solutions, grid integration, 
                  and comprehensive monitoring for sustainable business operations.
                </p>
              ...
              <div className="relative">
                ...
                <img
                  src={powerImage}
                  alt="Professional Solar System Installation"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our solar systems provide clean, renewable energy with advanced monitoring 
              and battery storage for complete energy independence.
            </p>
          </div>
